import { JRPCEngine, SafeEventEmitter } from "@web3auth/auth";
import { BROADCAST_CHANNELS_MSGS_TYPE } from "../enums";
import { BaseConfig, BaseControllerEvents, BaseState, IWindow, WindowBlockAlertParams } from "../interfaces";
...
export interface StreamWindowConfig extends BaseConfig {
     ...
     * Otherwise, we will open a new window.
     */
    isWindowAlreadyOpen: boolean;
    /**
...
export interface PopupHandlerConfig extends StreamWindowConfig {
     ...
     * after receiving the popup_closed event.
     */
    timeout?: number;
}
...
export interface PopupHandlerEvents<S> extends BaseControllerEvents<S> {
    close: () => void;
}
