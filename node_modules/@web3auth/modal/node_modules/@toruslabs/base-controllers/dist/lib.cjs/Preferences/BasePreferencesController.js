...
require('../enums.js');
var WSApiClient = require('../WSApiClient.js');
...
class BasePreferencesController extends BaseController.BaseController {
  ...
  constructor({
    ...
    this.wsApiClient = WSApiClient.WSApiClient(this.config.api, this);
  }
  ...
  async storeUserLogin(params) {
    ...
    if (!options.rehydrate) {
      ...
      const specialBrowser = utils.getCustomDeviceInfo();
  ...
  async getMessageForSigning(publicAddress, web3AuthIdToken) {
    const response = await httpHelpers.post(`${this.config.api}/auth/message`, {
  ...
  async refreshJwt() {
    ...
    const response = await httpHelpers.post(`${this.config.api}/auth/verify`, {
  ...
  async init(params) {
    ...
    switch (type) {
      case IPreferencesController.ACCOUNT_CATEGORY.EXTERNAL:
        {
          ...
          const response = await httpHelpers.post(`${this.config.api}/auth/verify`, _objectSpread({
            account_type: type,
            public_address: address,
            id_token: idToken,
      ...
      case IPreferencesController.ACCOUNT_CATEGORY.IMPORTED:
      ...
      case IPreferencesController.ACCOUNT_CATEGORY.MPC:
      case IPreferencesController.ACCOUNT_CATEGORY.SFA:
      case IPreferencesController.ACCOUNT_CATEGORY.SFA_ACCOUNT_ABSTRACTION:
        {
  ...
  headers(address) {
    ...
    const selectedAddress = address || this.state.selectedAddress;
    return utils.getHeaders(((_this$getAddressState8 = this.getAddressState(selectedAddress)) === null || _this$getAddressState8 === void 0 ? void 0 : _this$getAddressState8.jwtToken) || "", selectedAddress);
  }
}
