...
class StreamWindow extends BaseController.BaseController {
  constructor({
    config,
    state
  }) {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (!this.config.isWindowAlreadyOpen) {
        ...
        communicationEngine.emit("notification", {
          method: enums.COMMUNICATION_NOTIFICATIONS.IFRAME_STATUS,
          params: {
            isFullScreen: true,
        ...
        const channelName = `${enums.BROADCAST_CHANNELS.REDIRECT_CHANNEL}_${this.config.instanceId}_${this.state.windowId}`;
  ...
  close() {
    ...
    if (this.config.isWindowAlreadyOpen) {
      communicationEngine.emit("notification", {
        method: enums.COMMUNICATION_NOTIFICATIONS.CLOSE_WINDOW,
        params: {
          windowId: this.state.windowId
        }
      });
...
exports.StreamWindow = StreamWindow;
