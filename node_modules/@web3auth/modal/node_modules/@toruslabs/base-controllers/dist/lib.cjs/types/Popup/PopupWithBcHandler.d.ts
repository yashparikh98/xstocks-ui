 ...
 */
export declare class PopupWithBcHandler<ReceiveData, SendData = unknown> extends PopupHandler {
    channelPrefix: string;
    constructor({ config, state, channelPrefix, }: {
        config: Partial<PopupHandlerConfig>;
        state: Partial<PopupHandlerState> & Pick<PopupHandlerState, "url" | "windowId">;
        channelPrefix: string;
    });
    /**
