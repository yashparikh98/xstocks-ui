...
class CommunicationProvider extends baseProvider {
  constructor(connectionStream, {
    ...
    const notificationHandler = payload => {
      ...
      } else if (method === baseControllers.COMMUNICATION_NOTIFICATIONS.TOGGLE_WIDGET_BUTTON) {
        const {
          show
        } = params;
        this.state.widgetVisibility = show;
        this.displayIframe();
      } else if (method === baseControllers.COMMUNICATION_NOTIFICATIONS.ALLOW_WALLET_SERVICE) {
        const {
          allow
        } = params;
  ...
  handleConnect(currentAuthConnection, isLoggedIn) {
    if (!this.state.isConnected) {
      ...
      loglevel.debug(messages.info.connected(currentAuthConnection));
    }
  }
  /**
