import type { AuthConnectionConfig, JRPCEngineEndCallback, JRPCEngineNextCallback, JRPCRequest, JRPCResponse, WEB3AUTH_NETWORK_TYPE, WhiteLabelData } from "@web3auth/auth";
...
export interface BaseEmbedControllerState extends BaseState {
    ...
    authConnectionConfig: AuthConnectionConfig | undefined;
...
export interface ICommunicationProviderHandlers {
    ...
    showWalletConnect: (req: JRPCRequest<BaseEmbedControllerState["showWalletConnect"]>, res: JRPCResponse<boolean>, next: JRPCEngineNextCallback, end: JRPCEngineEndCallback) => void;
    showFunding: (req: JRPCRequest<BaseEmbedControllerState["showFunding"]>, res: JRPCResponse<boolean>, next: JRPCEngineNextCallback, end: JRPCEngineEndCallback) => void;
    showCheckout: (req: JRPCRequest<BaseEmbedControllerState["showCheckout"]>, res: JRPCResponse<boolean>, next: JRPCEngineNextCallback, end: JRPCEngineEndCallback) => void;
    showReceive: (req: JRPCRequest<BaseEmbedControllerState["showReceive"]>, res: JRPCResponse<boolean>, next: JRPCEngineNextCallback, end: JRPCEngineEndCallback) => void;
    showTransfer: (req: JRPCRequest<BaseEmbedControllerState["showTransfer"]>, res: JRPCResponse<boolean>, next: JRPCEngineNextCallback, end: JRPCEngineEndCallback) => void;
    showWalletUi: (req: JRPCRequest<BaseEmbedControllerState["showWalletUi"]>, res: JRPCResponse<boolean>, next: JRPCEngineNextCallback, end: JRPCEngineEndCallback) => void;
    showSwap: (req: JRPCRequest<BaseEmbedControllerState["showSwap"]>, res: JRPCResponse<boolean>, next: JRPCEngineNextCallback, end: JRPCEngineEndCallback) => void;
