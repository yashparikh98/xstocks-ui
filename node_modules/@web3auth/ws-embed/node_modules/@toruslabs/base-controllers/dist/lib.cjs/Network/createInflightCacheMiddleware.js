...
function createInflightCacheMiddleware({
  ...
  async function createActiveRequestHandler(res, activeRequestHandlers) {
    ...
    activeRequestHandlers.push(handledRes => {
      ...
      res.result = lodashUtils.cloneDeep(handledRes.result);
      res.error = lodashUtils.cloneDeep(handledRes.error);
      resolve();
    });
    return promise;
  }
  ...
  return auth.createAsyncMiddleware(async (req, res, next) => {
