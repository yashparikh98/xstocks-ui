...
export declare const TX_EVENTS: {
    readonly TX_WARNING: "tx:warning";
    readonly TX_ERROR: "tx:error";
    readonly TX_FAILED: "tx:failed";
    readonly TX_CONFIRMED: "tx:confirmed";
    readonly TX_DROPPED: "tx:dropped";
    readonly TX_EXPIRED: "tx:expired";
    readonly TX_STATUS_UPDATE: "tx:status_update";
    readonly TX_UNAPPROVED: "tx:unapproved";
    readonly TX_RETRY: "tx:retry";
    readonly TX_BLOCK_UPDATE: "tx:block_update";
};
...
export type SpecificTransactionEvents = {
    [TX_EVENTS.TX_STATUS_UPDATE]: (data: TX_STATUS_UPDATE_EVENT_TYPE) => void;
};
export type GenericTransactionEvents<U> = {
    [event: `${string}:finished`]: (data: U) => void;
    [event: `${string}:${TransactionStatus}`]: (txId: string) => void;
};
export type BaseTransactionEvents<S, U> = BaseControllerEvents<S> & SpecificTransactionEvents & GenericTransactionEvents<U>;
export interface BaseFormattedTransactionActivity {
    id: string;
    date: string;
    from: string;
    slicedFrom: string;
