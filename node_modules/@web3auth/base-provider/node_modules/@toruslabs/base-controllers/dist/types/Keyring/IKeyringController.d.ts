...
export type AccountType = "imported" | "web3auth";
export type KeyPair = {
    /**
...
export interface IKeyringController {
     ...
     */
    signTransaction<T, U>(tx: T, withAddress: string, txOptions?: Record<string, unknown>): Promise<U>;
    signAuthMessage(address: string, message: string): Promise<string>;
}
