...
import { BaseTransactionEvents, TransactionConfig, TransactionMeta, TransactionState, TransactionStatus } from "./ITransactionController";
export declare class BaseTransactionStateManager<T, U extends TransactionMeta<T> = TransactionMeta<T>, E extends BaseTransactionEvents<TransactionState<T, U>, U> = BaseTransactionEvents<TransactionState<T, U>, U>> extends BaseController<TransactionConfig, TransactionState<T, U>, E & BaseTransactionEvents<TransactionState<T, U>, U>> {
