...
import { BROADCAST_CHANNELS, SETUP_COMPLETE, POPUP_LOADED } from '../enums.js';
import { handleRedirectParameters, broadcastChannelOptions } from '../utils/utils.js';
    ...
    return new Promise((resolve, reject) => {
      ...
      try {
        ...
        bc.addEventListener("message", async ev => {
          ...
          if (url) {
            resolve();
            // TODO: this is not working in playwright for firefox
