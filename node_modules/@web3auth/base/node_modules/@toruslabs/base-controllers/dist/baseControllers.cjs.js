...
__webpack_require__.d(__webpack_exports__, {
  ...
  BaseController: () => (/* reexport */ BaseController),
  ...
  CommunicationWindowManager: () => (/* reexport */ CommunicationWindowManager),
  ControllerEvents: () => (/* reexport */ ControllerEvents),
  DEFAULT_IDLE_TIME: () => (/* reexport */ DEFAULT_IDLE_TIME),
  ...
  WSApiClient: () => (/* reexport */ WSApiClient),
  ...
  createIdleTracker: () => (/* reexport */ createIdleTracker),
 ...
 */
class BaseController extends auth_namespaceObject.SafeEventEmitter {
  /**
...
;// ./src/createEventEmitterProxy.ts
...
;// ./src/Currency/BaseCurrencyController.ts
...
;// ./src/Embed/CommunicationMethodMiddleware.ts
...
function createCommunicationMiddleware(providerHandlers) {
  ...
  return (0,auth_namespaceObject.mergeMiddleware)([createChangeProviderMiddlewareMiddleware({
    changeProvider
  }), createTopupMiddleware({
    topup
  }), (0,auth_namespaceObject.createScaffoldMiddleware)({
...
;// ./src/Embed/BaseEmbedController.ts
...
class BaseEmbedController extends BaseController {
  ...
  initializeProvider(handlers) {
    ...
    const communicationProvider = (0,auth_namespaceObject.providerFromEngine)(engine);
...
;// ./src/Embed/CommunicationWindowManager.ts



class CommunicationWindowManager extends auth_namespaceObject.SafeEventEmitter {
  constructor(...args) {
    super(...args);
...
const handleRedirectParameters = (hash, queryParameters) => {
  ...
  if (!queryParameters.windowId) {
    if (Object.keys(hashParameters).length > 0 && hashParameters.state) {
      instanceParameters = JSON.parse((0,auth_namespaceObject.safeatob)(decodeURIComponent(decodeURIComponent(hashParameters.state)))) || {};
      error = hashParameters.error_description || hashParameters.error || error;
    } else if (Object.keys(queryParameters).length > 0 && queryParameters.state) {
      instanceParameters = JSON.parse((0,auth_namespaceObject.safeatob)(decodeURIComponent(decodeURIComponent(queryParameters.state)))) || {};
...
;// ./src/Keyring/BaseKeyringController.ts
...
;// ./src/Network/createFetchMiddleware.ts
...
function checkForHttpErrors(fetchRes) {
  ...
  switch (fetchRes.status) {
    case 405:
      throw auth_namespaceObject.rpcErrors.methodNotFound();
    case 418:
      throw auth_namespaceObject.rpcErrors.internal({
...
function createFetchMiddleware({
  ...
  return (0,auth_namespaceObject.createAsyncMiddleware)(async (req, res, _next) => {
    const {
      fetchUrl,
      fetchParams
...
;// ./src/Network/createInflightCacheMiddleware.ts
...
function createInflightCacheMiddleware({
  ...
  return (0,auth_namespaceObject.createAsyncMiddleware)(async (req, res, next) => {
...
;// ./src/Network/createLoggerMiddleware.ts
...
;// ./src/Network/createOriginMiddleware.ts
...
;// ./src/Network/INetworkController.ts
...
;// ./src/Popup/PopupStoreChannel.ts
...
;// ./src/Popup/PopupWithBcHandler.ts
...
;// ./src/Preferences/IPreferencesController.ts
 ...
 */
;// ./src/Preferences/BasePreferencesController.ts
...
class BasePreferencesController extends BaseController {
  ...
  constructor({
    ...
    defineProperty_default()(this, "chainNamespace", void 0);
  ...
  async createUser(params) {
    ...
    const userPayload = objectSpread2_default()({
...
;// ./src/Transaction/ITransactionController.ts
/**
 ...
 */
;// ./src/Transaction/BaseTransactionStateController.ts
