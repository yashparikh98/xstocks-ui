...
import { BaseBlockTrackerConfig, BaseBlockTrackerEvents, BaseBlockTrackerState } from "./IBlockTrackerController";
export declare class BaseBlockTracker<T extends {
    idempotencyKey: string;
}, C extends BaseBlockTrackerConfig, S extends BaseBlockTrackerState<T>> extends BaseController<C, S, BaseBlockTrackerEvents<T, S>> {
    name: string;
    ...
    removeAllListeners(eventName?: string | number): this;
    /**
