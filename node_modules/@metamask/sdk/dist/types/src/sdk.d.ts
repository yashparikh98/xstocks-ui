 ...
 */
export declare const defaultMetaMaskSDKOptions: MetaMaskSDKOptions;
export declare class MetaMaskSDK extends EventEmitter2 {
    ...
    private _anonId;
    private readonly ANON_ID_STORAGE_KEY;
