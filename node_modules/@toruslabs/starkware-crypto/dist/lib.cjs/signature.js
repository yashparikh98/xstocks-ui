...
var constant_points = require('./constant_points.js');
...
const constantPoints = constant_points.map(coords => starkEc.curve.point(new BN(coords[0], 16), new BN(coords[1], 16)));
...
exports.ec = ec;
exports.fixMsgHashLen = fixMsgHashLen;
