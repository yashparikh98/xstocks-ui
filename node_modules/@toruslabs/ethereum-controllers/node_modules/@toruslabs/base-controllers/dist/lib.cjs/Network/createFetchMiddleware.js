...
function checkForHttpErrors(fetchRes) {
  ...
  switch (fetchRes.status) {
    case 405:
      throw auth.rpcErrors.methodNotFound();
    case 418:
      throw auth.rpcErrors.internal({
...
function createFetchMiddleware({
  ...
  return auth.createAsyncMiddleware(async (req, res, _next) => {
    ...
    const isSkippedAnalytics = !Object.values(constants.ANALYTICS_TRACKED_NETWORK_JPRC_METHODS).includes(req.method);
    const trackData = {
      chain_id: utils.getCaipChainId(providerConfig),
      chain_rpc_target: utils.getHostname(fetchUrl),
      method: req.method
    };
      ...
      try {
        ...
        if (!isSkippedAnalytics) {
          analytics === null || analytics === void 0 || analytics.track(constants.ANALYTICS_EVENTS.JRPC_REQUEST_COMPLETED, _objectSpread(_objectSpread({
            request_type: constants.ANALYTICS_JRPC_REQUEST_TYPES.NETWORK
          }, trackData), {}, {
        ...
        if (!isRetriable) {
          if (!isSkippedAnalytics) {
            analytics === null || analytics === void 0 || analytics.track(constants.ANALYTICS_EVENTS.JRPC_REQUEST_FAILED, _objectSpread(_objectSpread({
              request_type: constants.ANALYTICS_JRPC_REQUEST_TYPES.NETWORK
            }, trackData), {}, {
          ...
          const error = await auth.serializeError(err);
          throw error;
        }
      }
