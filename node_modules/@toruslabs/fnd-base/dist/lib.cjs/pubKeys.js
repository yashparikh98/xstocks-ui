...
const SAPPHIRE_NODE_PUB_KEYS = {
  [constants.TORUS_SAPPHIRE_NETWORK.SAPPHIRE_MAINNET]: [{
  ...
  [constants.TORUS_SAPPHIRE_NETWORK.SAPPHIRE_DEVNET]: [{
...
exports.SAPPHIRE_NODE_PUB_KEYS = SAPPHIRE_NODE_PUB_KEYS;
