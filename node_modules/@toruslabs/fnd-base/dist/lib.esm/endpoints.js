import { KEY_TYPE, TORUS_SAPPHIRE_NETWORK, LEGACY_NETWORKS_ROUTE_MAP, SIG_TYPE } from '@toruslabs/constants';
...
const getTSSEndpoints = (sapphireNetwork, legacyNetwork, keyType = KEY_TYPE.SECP256K1, sigType) => {
  const endpoints = SAPPHIRE_NETWORK_URLS[sapphireNetwork];
  if (!endpoints || endpoints.length === 0) {
    throw new Error(`Unsupported network: ${sapphireNetwork}`);
  }
