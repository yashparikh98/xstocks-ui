import type { Abi, Chain, Client, ContractFunctionArgs, ContractFunctionName, GetCallsStatusReturnType, Hash, SendCallsReturnType, Transport, TypedData, WriteContractParameters } from "viem";
...
export type SmartAccountActions<TChain extends Chain | undefined = Chain | undefined, TSmartAccount extends SmartAccount | undefined = SmartAccount | undefined> = {
    ...
    sendCalls: <TChainOverride extends Chain | undefined = undefined, accountOverride extends SmartAccount | undefined = undefined, calls extends readonly unknown[] = readonly unknown[]>(args: Parameters<typeof sendCalls<TSmartAccount, TChain, accountOverride, TChainOverride, calls>>[1]) => Promise<SendCallsReturnType>;
    getCallsStatus: (args: Parameters<typeof getCallsStatus<TSmartAccount, TChain>>[1]) => Promise<GetCallsStatusReturnType>;
};
