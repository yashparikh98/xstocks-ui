 ...
 *
 */
export declare const getUserOperationStatus: (client: Client<Transport, Chain | undefined, Account | undefined, PimlicoRpcSchema>, { hash }: GetUserOperationStatusParameters) => Promise<GetUserOperationStatusReturnType>;
