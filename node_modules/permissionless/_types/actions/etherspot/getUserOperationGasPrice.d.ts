 ...
 */
export declare const getUserOperationGasPrice: (client: Client<Transport, Chain | undefined, Account | undefined, EtherspotBundlerRpcSchema>) => Promise<GetGasPriceResponseReturnType>;
