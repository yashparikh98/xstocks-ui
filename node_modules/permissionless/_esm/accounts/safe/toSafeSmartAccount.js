...
import { concatSignatures, getWebAuthnSignature, signUserOperation } from "./signUserOperation.js";
const multiSendAbi = [
    {
        inputs: [
            {
...
export async function toSafeSmartAccount(parameters) {
    ...
    return toSmartAccount({
        ...
        async getStubSignature() {
            ...
            return encodePacked(["uint48", "uint48", "bytes"], [0, 0, concatSignatures(signatures)]);
        },
        async sign({ hash }) {
