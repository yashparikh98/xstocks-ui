...
import { concatHex, decodeAbiParameters, encodeAbiParameters, encodePacked, hashTypedData } from "viem";
import { toOwner } from "../../utils/index.js";
import { EIP712_SAFE_OPERATION_TYPE_V06, EIP712_SAFE_OPERATION_TYPE_V07, getDefaultAddresses, getPaymasterAndData, isWebAuthnAccount } from "./toSafeSmartAccount.js";
export const concatSignatures = (signatures) => {
...
export const getWebAuthnSignature = async ({ owner, hash }) => {
...
export async function signUserOperation(parameters) {
    ...
    return encodePacked(["uint48", "uint48", "bytes"], [validAfter, validUntil, concatSignatures(signatures)]);
}
