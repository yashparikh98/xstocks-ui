...
exports.getPimlicoEstimationCallData = getPimlicoEstimationCallData;
const viem_1 = require("viem");
const account_abstraction_1 = require("viem/account-abstraction");
function getPimlicoEstimationCallData06({ userOperation, entrypoint }) {
    return {
...
function encodeSimulateHandleOpLast({ userOperation }) {
    const userOperations = [userOperation];
    const packedUserOperations = userOperations.map((uop) => ({
        packedUserOperation: (0, account_abstraction_1.toPackedUserOperation)(uop)
    }));
...
function getPimlicoEstimationCallData07({ userOperation, estimationAddress, entrypoint }) {
...
function isEntryPoint06(args) {
    return args.entrypoint.version === "0.6";
}
function isEntryPoint07(args) {
    return args.entrypoint.version === "0.7";
}
function isEntryPoint08(args) {
    return args.entrypoint.version === "0.8";
}
function getPimlicoEstimationCallData(args) {
...
//# sourceMappingURL=getEstimationCallData.js.map