...
export type { AnalyticsBrowserSettings, CDNSettings, RemoteIntegrationSettings, AnalyticsSettings, InitOptions, } from './browser/settings';
export * from './node';
...
export { resolveAliasArguments, resolveArguments, resolvePageArguments, resolveUserArguments, } from './core/arguments-resolver';
