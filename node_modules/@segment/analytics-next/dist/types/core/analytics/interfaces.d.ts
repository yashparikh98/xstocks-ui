...
import type { EventParams, DispatchedEvent, PageParams, IdentifyParams, AliasParams, GroupParams } from '../arguments-resolver';
 ...
 */
export interface AnalyticsBrowserCore extends Omit<AnalyticsCore, 'group' | 'user'> {
    /**
     * Gets the group.
