...
"[project]/node_modules/@web3auth/modal/dist/lib.esm/packages/modal/src/ui/i18n/spanish.json.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var modal = {
    ...
    "connect-wallet.more-wallets": "Más carteras",
    connectYourWallet: "Conecte su portefeuille",
    ...
    "external.continue-custom": "Continuar con {{wallet}}",
    ...
    "external.qr-code-copied-to-clipboard": "URI copiado al portapapeles",
    ...
    "external.select-chain": "Seleccionar cadena",
    "external.select-chain-description": "Este {{wallet}} billetera soporta varias cadenas. Seleccione la cadena que desea conectar",
    "external.title": "Billetera Externa",
    "external.walletconnect-connect": "Conectar",
    "external.walletconnect-copy": "Escanee el código QR con una billetera compatible con WalletConnect o haga clic en el código QR para copiar el enlace",
    "external.walletconnect-subtitle": "Escanear el código QR con una billetera compatible con WalletConnect",
    "footer.and": "y",
    "footer.by-signing-in": "Al iniciar sesión, acepta nuestros",
    ...
    "footer.terms-of-service": "Términos de uso",
    ...
    "network.to": "A",
    "otp.email-subtext": "Por favor, ingrese el código de verificación de 6 dígitos",
    "otp.email-subtext-example": "que fue enviado a su email {{email}}",
    "otp.email-title": "Verificación de email",
    "otp.mobile-subtext": "Verificación OTP",
    "otp.mobile-title": "Verificación OTP",
    "otp.success": "¡Estás conectado a tu cuenta!",
    ...
    "passwordless.title": "Continuar con {{title}}",
    ...
    resendTimer: " Reenviar en {{timer}} segundos",
...
var passwordless = {
    ...
    "error-invalid-params": "Parámetros faltantes o no válidos",
    "error-invalid-test-account": "Cuenta de prueba no válida",
    "error-max-retry-limit-reached": "Has alcanzado el límite para intentos incorrectos. Reinicie el proceso para completar la verificación.",
    "error-new-link-generated-heading": "Nuevo enlace de verificación generado",
    "error-no-mail-generated": "No se generó el correo. Inicie primero el proceso sin contraseña.",
    "error-no-sms-generated": "No se generó OTP. Inicie primero el proceso sin contraseña.",
    "error-otp-expired": "OTP expiró",
...
//# sourceMappingURL=a9bf9_%40web3auth_modal_dist_lib_esm_packages_modal_src_ui_i18n_spanish_json_8aa504df.js.map