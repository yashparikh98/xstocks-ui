...
"[project]/node_modules/@web3auth/no-modal/dist/lib.esm/connectors/injected-solana-connector/index.js [app-client] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
const hasSolanaWalletStandardFeatures = (wallet)=>{
    ...
    ].every((feature)=>Object.keys(features).includes(feature));
    if (!hasRequiredFeatures) return false;
    return true;
};
;
}),
"[project]/node_modules/@web3auth/no-modal/dist/lib.esm/connectors/base-solana-connector/baseSolanaConnector.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class BaseSolanaConnector extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$connector$2f$baseConnector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseConnector"] {
    async init(_) {}
    async getIdentityToken() {
        ...
        const accounts = await this.provider.request({
            method: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$ws$2d$embed$2f$dist$2f$lib$2e$esm$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SOLANA_METHOD_TYPES"].GET_ACCOUNTS
        });
        if (accounts && accounts.length > 0) {
            ...
            const signedMessage = await this.provider.request({
                method: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$ws$2d$embed$2f$dist$2f$lib$2e$esm$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SOLANA_METHOD_TYPES"].SIGN_MESSAGE,
                params: {
                    data: challenge,
                    display: "utf8"
                }
...
"[project]/node_modules/@web3auth/no-modal/dist/lib.esm/providers/solana-provider/providers/injectedProviders/base/baseInjectedProvider.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
class BaseInjectedProvider extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$base$2d$provider$2f$baseProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseProvider"] {
    ...
    async switchChain(_) {
        throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$errors$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WalletLoginError"].unsupportedOperation("Chain switching is not supported by this connector");
    }
    async setupProvider(injectedProvider, chainId) {
        ...
        const solanaMiddleware = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$solana$2d$provider$2f$rpc$2f$solanaRpcMiddlewares$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createSolanaMiddleware"])(providerHandlers);
        engine.push(solanaMiddleware);
        const configMiddleware = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$solana$2d$provider$2f$rpc$2f$JrpcClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createConfigMiddleware"])(chain);
...
"[project]/node_modules/@web3auth/no-modal/dist/lib.esm/providers/solana-provider/providers/injectedProviders/base/providerHandlers.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "getBaseProviderHandlers",
    ()=>getBaseProviderHandlers
]);
    ...
    const providerHandlers = {
        requestAccounts: async ()=>{
            return injectedProvider.publicKey ? [
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$toruslabs$2f$bs58$2f$dist$2f$lib$2e$esm$2f$bs58$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bs58"].encode(injectedProvider.publicKey.toBytes())
            ] : [];
        },
        getPublicKey: async ()=>{
            return injectedProvider.publicKey ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$toruslabs$2f$bs58$2f$dist$2f$lib$2e$esm$2f$bs58$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bs58"].encode(injectedProvider.publicKey.toBytes()) : "";
        },
        ...
        signAllTransactions: async (req)=>{
            ...
            if (!((_req$params = req.params) !== null && _req$params !== void 0 && _req$params.message) || !((_req$params2 = req.params) !== null && _req$params2 !== void 0 && _req$params2.message.length)) {
                throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$node_modules$2f40$web3auth$2f$auth$2f$dist$2f$lib$2e$esm$2f$jrpc$2f$errors$2f$errors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rpcErrors"].invalidParams("message");
            }
...
"[project]/node_modules/@web3auth/no-modal/dist/lib.esm/providers/solana-provider/providers/injectedProviders/utils.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@web3auth/no-modal/dist/lib.esm/providers/solana-provider/providers/injectedProviders/walletStandardProvider.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$toruslabs$2f$bs58$2f$dist$2f$lib$2e$esm$2f$bs58$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@toruslabs/bs58/dist/lib.esm/bs58.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$solana$2d$provider$2f$providers$2f$injectedProviders$2f$base$2f$baseInjectedProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@web3auth/no-modal/dist/lib.esm/providers/solana-provider/providers/injectedProviders/base/baseInjectedProvider.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$solana$2d$provider$2f$providers$2f$injectedProviders$2f$base$2f$providerHandlers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@web3auth/no-modal/dist/lib.esm/providers/solana-provider/providers/injectedProviders/base/providerHandlers.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$solana$2d$provider$2f$providers$2f$injectedProviders$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@web3auth/no-modal/dist/lib.esm/providers/solana-provider/providers/injectedProviders/utils.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$errors$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@web3auth/no-modal/dist/lib.esm/base/errors/index.js [app-client] (ecmascript)");
;
;
;
...
;
;
class WalletStandardProvider extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$solana$2d$provider$2f$providers$2f$injectedProviders$2f$base$2f$baseInjectedProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseInjectedProvider"] {
    getProviderHandlers(wallet) {
        const chainIdentifier = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$solana$2d$provider$2f$providers$2f$injectedProviders$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSolanaChainByChainConfig"])(this.config.chain);
        const currentAccount = ()=>{
            const account = wallet === null || wallet === void 0 ? void 0 : wallet.accounts[0];
            if (!account) throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$errors$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WalletLoginError"].notConnectedError();
            return account;
        };
        /**
     ...
     */ const signMessage = async (message)=>{
            ...
            const uint8ArrayMessage = new Uint8Array(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(message, "utf-8"));
            const signature = await wallet.features[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$wallet$2d$standard$2d$features$2f$lib$2f$esm$2f$signMessage$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SolanaSignMessage"]].signMessage({
                account,
                message: uint8ArrayMessage
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$toruslabs$2f$bs58$2f$dist$2f$lib$2e$esm$2f$bs58$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bs58"].encode(signature[0].signature);
        };
        /**
     ...
     */ const signTransaction = async (transaction)=>{
            const account = currentAccount();
            const output = await wallet.features[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$wallet$2d$standard$2d$features$2f$lib$2f$esm$2f$signTransaction$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SolanaSignTransaction"]].signTransaction({
                account,
                transaction: new Uint8Array(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(transaction, "base64")),
                chain: chainIdentifier
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$toruslabs$2f$bs58$2f$dist$2f$lib$2e$esm$2f$bs58$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bs58"].encode(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VersionedTransaction"].deserialize(output[0].signedTransaction).signatures[0]);
        };
        /**
     ...
     */ const signAllTransactions = async (transactions)=>{
            ...
            return Promise.all(transactions.map(async (transaction)=>{
                ...
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(output[0].signedTransaction).toString("base64");
            }));
        };
        /**
     ...
     */ const signAndSendTransaction = async (transaction)=>{
            const account = currentAccount();
            const output = await wallet.features[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$wallet$2d$standard$2d$features$2f$lib$2f$esm$2f$signAndSendTransaction$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SolanaSignAndSendTransaction"]].signAndSendTransaction({
                account,
                transaction: new Uint8Array(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(transaction, "base64")),
                chain: chainIdentifier
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$toruslabs$2f$bs58$2f$dist$2f$lib$2e$esm$2f$bs58$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bs58"].encode(output[0].signature);
        };
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$solana$2d$provider$2f$providers$2f$injectedProviders$2f$base$2f$providerHandlers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBaseProviderHandlers"])({
            get publicKey () {
                return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$solana$2f$web3$2e$js$2f$lib$2f$index$2e$browser$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PublicKey"](currentAccount().publicKey);
            },
            signMessage,
            signTransaction,
            signAllTransactions,
...
"[project]/node_modules/@web3auth/no-modal/dist/lib.esm/connectors/injected-solana-connector/walletStandardConnector.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$connectors$2f$base$2d$solana$2d$connector$2f$baseSolanaConnector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@web3auth/no-modal/dist/lib.esm/connectors/base-solana-connector/baseSolanaConnector.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$solana$2d$provider$2f$providers$2f$injectedProviders$2f$walletStandardProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@web3auth/no-modal/dist/lib.esm/providers/solana-provider/providers/injectedProviders/walletStandardProvider.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$solana$2d$provider$2f$providers$2f$injectedProviders$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@web3auth/no-modal/dist/lib.esm/providers/solana-provider/providers/injectedProviders/utils.js [app-client] (ecmascript)");
...
;
;
class WalletStandardConnector extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$connectors$2f$base$2d$solana$2d$connector$2f$baseSolanaConnector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BaseSolanaConnector"] {
    constructor(options){
        super(options);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$defineProperty$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(this, "isInjected", true);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$defineProperty$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(this, "wallet", null);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$babel$2f$runtime$2f$helpers$2f$esm$2f$defineProperty$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(this, "injectedProvider", null);
        ...
        this.wallet = [
            "gate",
            "solflare"
        ].includes(this.name) ? Object.freeze(options.wallet) : options.wallet;
    }
    get provider() {
        if (this.status !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$connector$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONNECTOR_STATUS"].NOT_READY && this.injectedProvider) {
    ...
    async init(options) {
        ...
        this.injectedProvider = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$solana$2d$provider$2f$providers$2f$injectedProviders$2f$walletStandardProvider$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WalletStandardProvider"]({
            config: {
                chain: chainConfig,
        ...
        this.emit(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$connector$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONNECTOR_EVENTS"].READY, this.name);
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$loglevel$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["log"].debug("initializing solana injected connector");
    ...
    async connect({ chainId, getIdentityToken }) {
        try {
            ...
            const chainName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$providers$2f$solana$2d$provider$2f$providers$2f$injectedProviders$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSolanaChainByChainConfig"])(chainConfig);
            if (!this.wallet.chains.find((chain)=>chain === chainName)) throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$errors$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WalletLoginError"].connectionError(`Chain ${chainName} not supported. Supported chains are ${this.wallet.chains.join(", ")}`);
            if (!this.isWalletConnected) {
                await this.wallet.features[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wallet$2d$standard$2f$features$2f$lib$2f$esm$2f$connect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StandardConnect"]].connect();
            }
            if (this.wallet.accounts.length === 0) throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$errors$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WalletLoginError"].connectionError();
    ...
    async disconnect(options = {
        ...
        try {
            ...
            await ((_this$wallet$features = this.wallet.features[__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wallet$2d$standard$2f$features$2f$lib$2f$esm$2f$disconnect$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["StandardDisconnect"]]) === null || _this$wallet$features === void 0 ? void 0 : _this$wallet$features.disconnect());
            if (options.cleanup) {
            ...
            this.emit(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$connector$2f$constants$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CONNECTOR_EVENTS"].ERRORED, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$errors$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["WalletLoginError"].disconnectionError(error === null || error === void 0 ? void 0 : error.message));
        }
    }
    async getUserInfo() {
...
const walletStandardConnector = (wallet)=>{
    return ({ coreOptions })=>{
        return new WalletStandardConnector({
            name: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$base$2f$utils$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["normalizeWalletName"])(wallet.name),
            wallet,
            coreOptions
        });
    };
...
"[project]/node_modules/@web3auth/no-modal/dist/lib.esm/connectors/injected-solana-connector/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "createSolanaMipd",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$wallet$2d$standard$2f$app$2f$lib$2f$esm$2f$wallets$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getWallets"],
    "hasSolanaWalletStandardFeatures",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$connectors$2f$injected$2d$solana$2d$connector$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["hasSolanaWalletStandardFeatures"],
    "walletStandardConnector",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$connectors$2f$injected$2d$solana$2d$connector$2f$walletStandardConnector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["walletStandardConnector"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$connectors$2f$injected$2d$solana$2d$connector$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@web3auth/no-modal/dist/lib.esm/connectors/injected-solana-connector/index.js [app-client] (ecmascript) <locals>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$web3auth$2f$no$2d$modal$2f$dist$2f$lib$2e$esm$2f$connectors$2f$injected$2d$solana$2d$connector$2f$walletStandardConnector$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@web3auth/no-modal/dist/lib.esm/connectors/injected-solana-connector/walletStandardConnector.js [app-client] (ecmascript)");
}),
]);

//# sourceMappingURL=node_modules_a9464a10._.js.map