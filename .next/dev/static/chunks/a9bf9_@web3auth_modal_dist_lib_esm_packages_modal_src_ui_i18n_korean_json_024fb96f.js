...
"[project]/node_modules/@web3auth/modal/dist/lib.esm/packages/modal/src/ui/i18n/korean.json.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var modal = {
    ...
    allChains: "모든 체인",
    "connect-wallet.more-wallets": "더 많은 지갑",
    ...
    "external.continue-custom": "{{wallet}}로 계속하기",
    ...
    "footer.privacy-policy": "개인정보 취급 방침",
    "footer.terms": "이용 약관",
    "footer.terms-of-service": "이용 약관",
    ...
    "network.to": "받는 사람",
    "otp.email-subtext": "6자리 인증 코드를 입력하세요",
    "otp.email-subtext-example": "{{email}}에 전송된 것입니다",
    "otp.email-title": "이메일 검증",
    "otp.mobile-subtext": "OTP 검증",
    "otp.mobile-title": "OTP 검증",
    "otp.success": "당신은 당신의 계정에 연결되어 있습니다!",
    ...
    "passwordless.title": "{{title}} 로 계속하기",
    ...
    "social.passwordless-title": "이메일/전화번호",
    "social.phone": "전화번호",
...
var passwordless = {
    ...
    "error-no-sms-generated": "OTP가 생성되지 않았습니다. 비밀번호가 없는 절차부터 시작해 주세요.",
    "error-otp-expired": "OTP가 만료되었습니다",
...
//# sourceMappingURL=a9bf9_%40web3auth_modal_dist_lib_esm_packages_modal_src_ui_i18n_korean_json_024fb96f.js.map