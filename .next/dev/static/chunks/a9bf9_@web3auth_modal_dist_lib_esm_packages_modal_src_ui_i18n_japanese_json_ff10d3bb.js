...
"[project]/node_modules/@web3auth/modal/dist/lib.esm/packages/modal/src/ui/i18n/japanese.json.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var modal = {
    ...
    allChains: "すべてのチェーン",
    "connect-wallet.more-wallets": "ウォレットをもっと見る",
    ...
    "external.continue-custom": "{{wallet}}を続けます",
    ...
    "network.to": "へ",
    "otp.email-subtext": "6桁の検証コードを入力してください",
    "otp.email-subtext-example": "{{email}}に送信されたものです",
    "otp.email-title": "メール 検証",
    "otp.mobile-subtext": "OTP 検証",
    "otp.mobile-title": "OTP 検証",
    "otp.success": "あなたはあなたのアカウントに接続されています!",
    "passkey.add": "{パス}を追加",
...
var passwordless = {
    ...
    "error-otp-expired": "OTPの有効期限が切れました",
...
//# sourceMappingURL=a9bf9_%40web3auth_modal_dist_lib_esm_packages_modal_src_ui_i18n_japanese_json_ff10d3bb.js.map