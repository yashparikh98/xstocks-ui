...
"[project]/node_modules/@web3auth/modal/dist/lib.esm/packages/modal/src/ui/i18n/portuguese.json.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var modal = {
    ...
    "connect-wallet.more-wallets": "Mais carteiras",
    connectYourWallet: "Conecte seu portefeuille",
    ...
    "external.continue-custom": "Continue com o {{wallet}}",
    ...
    "footer.terms-of-service": "Termos de uso",
    "footer.terms-service": "Termos de Serviço",
    "footer.version": "Versão",
    getWallet: "Obter carteira",
    ...
    "network.to": "Para",
    "otp.email-subtext": "Por favor, insira o código de verificação de 6 dígitos",
    "otp.email-subtext-example": "que foi enviado para o seu email {{email}}",
    "otp.email-title": "Verificação de email",
    "otp.mobile-subtext": "Verifique o OTP enviado para",
    "otp.mobile-title": "Verificação OTP",
    "otp.success": "Você está conectado ao seu conta!",
    ...
    "passwordless.title": "Continuar com {{title}}",
    ...
    resendTimer: " Reenviar em {{timer}} segundos",
...
//# sourceMappingURL=f9924_modal_dist_lib_esm_packages_modal_src_ui_i18n_portuguese_json_514b1fef.js.map