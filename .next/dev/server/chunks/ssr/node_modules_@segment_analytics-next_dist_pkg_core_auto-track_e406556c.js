module.exports = [
"[project]/node_modules/@segment/analytics-next/dist/pkg/core/auto-track.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function link(links, event, properties, options) {
    ...
    elements.forEach(function(el) {
        el.addEventListener('click', function(elementEvent) {
            ...
            var trackEvent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$segment$2f$analytics$2d$core$2f$dist$2f$esm$2f$callback$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pTimeout"])(_this.track(ev, props, options !== null && options !== void 0 ? options : {}), (_b = _this.settings.timeout) !== null && _b !== void 0 ? _b : 500);
...
function form(forms, event, properties, options) {
    ...
    elements.forEach(function(el) {
        ...
        var handler = function(elementEvent) {
            ...
            var ev = event instanceof Function ? event(el) : event;
            var props = properties instanceof Function ? properties(el) : properties;
            var trackEvent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$segment$2f$analytics$2d$core$2f$dist$2f$esm$2f$callback$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["pTimeout"])(_this.track(ev, props, options !== null && options !== void 0 ? options : {}), (_a = _this.settings.timeout) !== null && _a !== void 0 ? _a : 500);
            trackEvent.catch(console.error).then(function() {
                el.submit();
            }).catch(console.error);
        };
...
//# sourceMappingURL=node_modules_%40segment_analytics-next_dist_pkg_core_auto-track_e406556c.js.map